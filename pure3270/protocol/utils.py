...
DATA_STREAM_SSCP = 0x0A  # DATA-STREAM-SSCP (RFC 2355 §3.2)
...
# Note: RFC 2355 does NOT define a positive response flag separately.
# "Positive response" is implied in ALWAYS-RESPONSE when no error occurs.
