...
def test_navigation_interface_completeness():
    ...
    interface_methods = [method for method in dir(session) if not method.startswith('_')]
    ...
    all_key_methods = (cursor_movement + field_navigation + directional + 
                      tab_navigation + aid_functions + text_operations + special_functions)
